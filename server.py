...
def find_apartments():
    ...
    return render_template("apts.html", raw_location=session['raw_location'], price=session['price'], distance=session['max_distance'], bedrooms=session['bedrooms'])
